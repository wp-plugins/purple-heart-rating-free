...
class WPB_Purple_Heart_Rating_Free_Metaboxes {
	...
	public function subscribe() {
		...
		<div class="wpbuddy-cr-form">
			<label for="text1210658"><?php echo __( 'Your first name', $this->_purple_heart->get_textdomain() ); ?></label>
			<input id="text1210658" name="209681" type="text" value="<?php echo $name; ?>" />
	...
	public function general() {
		...
		<a href="#" class="button wpbph-reset"><i class="icon icon-exchange"></i> <?php echo __( 'Reset to defaults', $this->_purple_heart->get_textdomain() ); ?>
		</a>
		...
		<div class="wpbph-backend-input wpbph-option">
			...
			<select name="wpbph[tracking]" id="wpbph_option_tracking">
				<option <?php if ( (bool) $this->_purple_heart->get_option( 'tracking' ) ) {
					echo 'selected="selected"';
				} ?> value="1"><?php echo __( 'Yes', $this->_purple_heart->get_textdomain() ); ?></option>
				<option <?php if ( ! (bool) $this->_purple_heart->get_option( 'tracking' ) ) {
					echo 'selected="selected"';
				} ?> value="0"><?php echo __( 'No', $this->_purple_heart->get_textdomain() ); ?></option>
			</select>
